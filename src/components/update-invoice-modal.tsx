...
export function UpdateInvoiceModal({ isOpen, onClose, onSubmit, products, invoice }: UpdateInvoiceModalProps) {
  ...
  useEffect(() => {
    if (isOpen && invoice && products.length > 0) {
      const formItems: InvoiceFormItem[] = products.map(product => {
  ...
  const calculateItemTotal = (item: InvoiceFormItem): number => {
    const product = products.find(p => p.id === item.productId);
      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="relative bg-background border border-border rounded-xl shadow-xl max-w-4xl w-full mx-auto max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center justify-between p-6 border-b border-border sticky top-0 bg-background">
            <div>
              <h2 className="text-xl font-semibold text-foreground">Update Invoice</h2>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label htmlFor="updateCustomerName" className="text-sm font-medium text-foreground">
              ...
              <div className="space-y-2">
                <label htmlFor="updateCustomerEmail" className="text-sm font-medium text-foreground">
                  Customer Email
                </label>
                <input
